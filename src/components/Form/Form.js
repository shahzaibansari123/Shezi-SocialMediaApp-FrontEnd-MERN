  ...
  return (
    <Paper className={classes.paper}>
      ...
      >
        ...
        <TextField className={classes.formInputs} name="tags" variant="outlined" label="Tags" fullWidth value={postData.tags} onChange={(e)=> setPostData({...postData, tags: e.target.value})}/>      
